...
// Before Annotation
let message = "My name is Husnain.";
console.log(message);
// After Annotation
...
let ch = prompt("Write the number to it is EVEN or ODD = ");
console.log(ch);
if (ch % 2 == 0) {
...
let age = prompt("Enter your age to eheck you are elegible to cast a vote or not = ");
console.log(age);
if (age >= 18) {
...
let year = prompt("Please Enter the year that you want to check is leap or not in '2000' formate = ");
